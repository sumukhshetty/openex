...
export default class BuyTradeOrder extends Component {
  ...
  handleTradeRequest (e) {
    e.preventDefault();
    this.props.requestEther(this.state.requestAmount, this.props.uid, this.props.params.orderId, this.props.sellOrderDetail.sellOrder.contractAddress, this.props.web3.web3);
  }
