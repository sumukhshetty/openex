    ...
    return (
      <div>
        ...
        <div className='flex mb3'>
          ...
          <input id='amount' type='number' onChange={this.props.onChangeProp} value={this.props.amount} className='w5 h-100' required/>
          <div className='min-w-30 me'>
        ...
        <div className='flex mb3'>
          ...
          <input id='minTransactionLimit' type='number' onChange={this.props.onChangeProp} value={this.props.minTransactionLimit} className='w5 inr h-100' required/>
          <div className='min-w-30 me'>
