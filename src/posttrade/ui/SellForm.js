    ...
    return (
      <div>
        ...
        <div className='flex mb3'>
          ...
          <input id='minTransactionLimit' type='number' onChange={this.props.onChangeProp} value={this.props.minTransactionLimit} className={`w5 h-100 ${this.props.currency === 'USD' ? 'usd' : 'inr'}`} required />
        ...
        <div className='flex mb3'>
          ...
          <input id='maxTransactionLimit' type='number' onChange={this.props.onChangeProp} value={this.props.maxTransactionLimit} className={`w5 h-100 ${this.props.currency === 'USD' ? 'usd' : 'inr'}`} required />
...
sell smart contract balance may limit the maximum fundable trade also.</span>
        ...
        <div className='flex mb3'>
          ...
          <input id='restrictTo' type='number' onChange={this.props.onChangeProp} value={this.props.restrictTo} className={`w5 h-100 ${this.props.currency === 'USD' ? 'usd' : 'inr'}`} required />
