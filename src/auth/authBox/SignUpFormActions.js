  ...
  return function(dispatch) {
    firebaseRef
      ...
      .once('value', function(snap) {
        if (snap.val()) {
          notify.show(
            'It looks like this account is already registered, please login'
          )
        } else {
          var userid = ''
          ...
          var data = toHex(
            'I am signing up for the EZ Ether marketplace and I have read the terms and conditions'
          )
                ...
                if (statusCode === 200) {
                  ...
                  firebaseRef
                    ...
                    .then(function(firebaseUser) {
                      ...
                      firebaseRef
                        ...
                        .then(function(result) {
                          ...
                          firebaseRef
                            .database()
                            .ref('/notificationsConfig/' + userid + '/email')
                            .set(email)
                    ...
                    .catch(function(error) {
                      // Handle Errors here.
                      notify.show(
                        'There was an error with you signing up. Please contact support.'
                      )
