export default {
  'en-US': {
    ...
    about: {
      ...
      section1caption1: `Building the stucture at Jaaga`,
      section1caption2: `The founding team at hillhacks`,
      ...
      section4caption1: `Escrow happens on the blockchain through a smart contract`,
...
`,
    ...
    how: {
      ...
      section1P1: `The present method to trade ether is either to use ethexindia, which has stop accepting new users. The only other the method is first buying bitcoins with all the fees involved in buying bitcoin, and then converting the bitcoins to ether in some exchange, adding fees in the process again.`,
      section1P2: `This not only makes it hard and time consuming, but also expensive. This is why we believed that there needed to be a better way to solve this problem globally.`,
      section1P3: `When we started digging deeper, we realised we can build a much more secure product than anything out there by using the web3 stack where we use smart contracts on the blockchain for escrow processing and dispute resolution. The web3 stack also ensures that users are in full control of their funds as we do not store private keys in any centralized server. Every user accessing our site, has to do so through a decentralized browser, which has a unique wallet address. This also helps us bypass the email and password authentication the internet has been plagued with.`,
      section1P4: `Alright, so what?`,
      section1P5: `You can access our site only through a decentralised browser.`,
      section2: `You need resilient infrastructure when new technologies are involved`,
      section2T1: `What is a decentralized browser ?`,
      section2P1: `A decentralized browser is like any other browser with a few special properties. Each browser has a unique identity in the form of a public wallet address, which can store funds. This wallet can interact with dApps by connecting the user to the blockchain. So instead of using a centralized backend database, we can use an immutable database for core transactions. You retain ownership of your Ether independent of the service, letting you use Ether at your own will without asking us to give you access.`,
      ...
      section2T4: `How do you handle private keys?`,
      section2P5: `Simple answer: We don’t !`,
      section2P6: `We basically never touch your private keys, as our application is a dApp you can access the site only through a decentralised browser, which means that when you log in, we sign an empty transaction to verify you are who you are. We do not use email and password to authenticate identity.`,
      section2T5: `Chrome/Firefox + Metamask = Decentralised Brower`,
      section2P7: `Metamask uses BIP39 to generate the private keys to your vault, they also don't store it. Only you have the seed which means only you can trade with it`,
      section2P8: `Metamask has a large user base and a proven track record of software maintenance and successful product feature releases since its been released. We believe that as the technology evolves Metamask will be able to keep up with the changing ecosystem.`,
      section3: `We’ll prepare you from the boom of upcoming Ethereum products and services`,
      section3P1: `We strongly believe that ethereum is going to be as disruptive to transactions as the internet was for information. There are extremely smart people work on problems such as peer to peer insurance, peer to peer credit, micropayments, replacing ad networks, supply chain, provenance, prediction markets, ROSCA’s, capital goods.`,
      section3P2: `All these are being developed and should be live in the next couple of months, but as of now there are already a bunch of live dApps that a user can make use of some of them being, ENS registrar, ICN, go to https://dapps.ethercasts.com/`,
      section3P3: `To run services on mosts dApp, a user requires ether. The biggest challenge for the user sometimes is getting his hands on ether. We want to make that easy for you. Our solution has one simple goal, to make buying and selling of ether, an easy and secure process.`,
      section3T1: `Service that support Ethereum right now:`,
      section3caption1: `service`,
      section3caption2: `service`,
      section3caption3: `service`,
      section3caption4: `service`,
      section4: `Fundamentally secure process`,
      ...
      section4T4: `What if the seller tries to cheat me ?`,
      section4P4: `The buyer has the rights to dispute the transaction to. Our support team will get in touch with both parties and look for proof of transaction. If there is a legitimate proof, we will send your wallet the eth.`,
      section4T5: `How can I trust the support team ?`,
      section4P5: `We also believe in the power of community, and think that ownership of the DAO should be with the stakeholders of the project. In the next few months, we intend to release a token that would allow us to create a better experience for our users and also help us fund development until we break even.`,
      section5: `We are completely transparent about fees`,
      section5P1: `We take a 1% fee for advertisers who post trades. No fees from direct buyers or seller. There are additional gas fees that go into the system which is again paid by the advertisers. This can vary, but gas fees are eventually going to decrease. As of now they are around 2$ per transaction but as ethereum scales, this problem should go away.`,
      section5P2: `We are looking at having a tiered pricing structure for our traders so that more frequent traders don’t end up loosing too much by trading. Traders end up making money  through the spread between buying and selling so it keeps the market efficient.`,
      section5P3: `A centralised exchange on the other hand could cost you anywhere between  2-5%. This is because they have a huge operational overhead compared to a system like ours and have to show their investors profits in the tunes of millions. Their only revenue stream being fees, can sometimes make them prohibitively expensive.`,
      section5P4: `We have seen other system that are similar (eg localbitcoins) which work very efficiently. We do not believe in overcharging our customers and by keeping a lean organization, we are able to charge much less than most other exchanges. `,
      section6: `Our system scales globally, and we really mean global.`,
      section6P1: `Unlike a centralized exchange that has bank accounts in each country they go to and come under the purview of regulators as business we are a marketplace that match buyers and sellers. This means that we can accept almost any form of bank/cash transfer as long as it verifiable by us (proof during dispute)`,
      section6P2: `A peer to peer exchange doesn’t come under the same regulations as a centralized exchange. We are not forced to do a KYC for every customer we have. But we are proactively doing a lite kyc using phone number verification. We expect all our users to follow their countries laws respectively and do not encourage them to use our system to break laws.`,
      section6P3: `Our goals for the next few months are to release a white paper, along with making the product better as we have identified multiple challenges in the onboarding process for new users.`
    },
    support: {
