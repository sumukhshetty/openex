    ...
    return (
      <div>
        <form className="mv3" onSubmit={this.handleSubmit.bind(this)}>
          <fieldset>
            <legend className="b f4 pv5">
              <FormattedMessage id="support.legend" />
            </legend>

            <div className="flex mv3">
              {/* <label htmlFor="email" className="w5">
                <FormattedMessage id="support.returnEmail" />
              </label> */}
              <input
                id="email"
                name="email"
                type="email"
                value={this.state.helpFormDetails.email}
                onChange={this.onInputChange.bind(this)}
                placeholder="Email Address"
                className="w-50 h-100 br3 pa2 b---gray"
                required
              />
              {/* <span className="measure-narrow fw1 i pa0 me">
                What is the email address you prefer to use for further
                communication.
              </span> */}
            </div>

            <div className="flex mv3">
              {/* <label htmlFor="topic" className="w5">
                Topic
              </label> */}
              <input
                id="topic"
                name="topic"
                type="text"
                value={this.state.helpFormDetails.topic}
                onChange={this.onInputChange.bind(this)}
                className="w-50 h-100 br3 pa2 b---gray"
                placeholder="Topic"
                required
            ...
            <div className="flex col mb3">
              <label htmlFor="message" className="measure f5 pv3">
                <FormattedMessage id="support.messageLabel" />
              </label>
              <textarea
                id="message"
                type="textArea"
                onChange={this.onInputChange.bind(this)}
                value={this.state.helpFormDetails.message}
                className="w-50 h-100 br3 pa2"
                // placeholder="Issues realted to specific transactions should have txid"
                rows="6"
                required
              />
              {/* <span className="measure-narrow fw1 i pa0 me">
                Please elaborate on the problem so that support can resolve the
