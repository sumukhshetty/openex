...
EZ Ether may use your personal information:
4. To identify you
...
7. Customize, measure, and improve EZ Ether Service and the content and layout of our Website and applications,
...
<p className='pv1'>
The Website may provide links or other forms of reference to other websites (“External Websites”) or resources over which we may not have control. You acknowledge that EZ Ether is providing any such links or references of External Websites or resources to you only as a convenience and that EZ Ether makes no representations whatsoever about any External Websites which you may access through this Website, including such External Websites being free of such items as viruses, worms, Trojan horses, and other items of a destructive nature. EZ Ether is not responsible for the availability of, and content provided on any External Websites. You are requested to review the policies posted by such External Websites regarding privacy and other topics before use. EZ Ether is not responsible for third party content accessible through the Website, including opinions, advice, statements, prices, activities, and advertisements, and you shall bear all risks associated with the use of such content.
</p>
<h1 className='pv1'>Financial Advice</h1>
<p className='pv1'>
We do not provide any investment advice in connection with the Service contemplated by these Terms of Use. While we may provide information on the value, range, volatility of Ethers, and events that may affect/have affected the value of Ethers, this is not considered investment advice and should not be construed as such. EZ Ether will not be liable for any loss suffered by you in connection with any transaction involving Ethers.
</p>
...
<p className='pv1'>
Email messages sent over Internet are not always secure and EZ Ether is not responsible for any damages incurred by the result of sending email messages over the Internet. We recommend sending sensitive emails by visiting ‘contact-us’ form on the Website where the information passes under security layer and is encrypted.
</p>
<h1 className='pv1'>Jurisdiction</h1>
<p className='pv1'>
These Terms of Use shall be governed and construed in accordance with the laws of India. The parties agree to irrevocably submit to the exclusive jurisdiction of the courts in Bangalore for the resolution of any disputes arising from these Terms of Use. EZ Ether may also consider arbitration as the appropriate mechanism for dispute resolution.
</p>
<h1 className='pv1'>Limitation of Liability</h1>
<p className='pv1'>
Users of this website are responsible for their actions in connection with the use of the Website, Service, and their Accounts. Users are also responsible for protecting access information to the Website including, but not limited to, user names, passwords, and bank account details. EZ Ether is not responsible for the outcome, whether positive or negative, of any action performed by any of its users within or related to the Website. Some deposits and withdrawal methods require EZ Ether to use personal details of the user including, but not limited to, name, address, email, phone number, and bank account number, IFSC code, etc. and you agree that EZ Ether can use these information to facilitate deposits and withdrawals.
</p>
<p className='pv1'>
The parties agree that in no event shall EZ Ether or its affiliates, officers, directors, agents, employees, and suppliers be liable for lost profits or any special, incidental or consequential damages arising out of or in connection with the use of our Website, Service, or theseTerms of Use.In case the applicable laws do not permit the limitation or exclusion of damages as described above, ouraggregate liability (including the liability of our affiliates, officers, directors, agents, employees, and suppliers)in respect of claims based on events arising out of or in connection with any single member’s use of the Website, whether in contract or tort or otherwise, shall in no circumstances exceed the amount of the transaction(s) that are the subject of the claim less any amount of commission that may be due and payable in respect of such transaction(s).
</p>
<h1 className='pv1'>Indemnity</h1>
<p className='pv1'>
To the full extent permitted by applicable law, you hereby agree to indemnify EZ Ether, and its affiliates, officers, directors, agents, employees, and suppliers against any action, liability, cost, claim, loss, damage, proceeding or expense suffered or incurred if direct or not directly arising from your use of the Website, Service, or from your violation of these Terms of Use.
</p>
